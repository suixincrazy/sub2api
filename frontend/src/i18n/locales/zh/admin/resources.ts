export default {
    scheduledTests: {
      title: '定时保活',
      description: '启用后持续发送短请求，失败时探活直至连通，成功后按保活间隔继续发送。限流时遵循上游等待时间。',
      addPlan: '添加保活',
      editPlan: '编辑保活',
      deletePlan: '删除保活',
      model: '文本模型',
      ...
      maxResults: '历史记录上限',
      noPlans: '暂无保活计划',
      confirmDelete: '确定删除此保活计划并停止后续请求吗？',
      createSuccess: '保活计划已创建',
      updateSuccess: '保活设置已更新',
      deleteSuccess: '保活计划已删除',
      results: '保活记录',
      noResults: '暂无保活记录',
      responseText: '响应',
      errorMessage: '错误',
      ...
      running: '请求中',
      schedule: '定时保活',
      probeInterval: '探活间隔（秒）',
      keepaliveInterval: '保活最短间隔（秒）',
      keepaliveMaxInterval: '保活最长间隔（秒）',
      intervalSummary: '失败每 {probe} 秒重试，连通后每 {min}–{max} 秒保活',
      paused: '已暂停',
      probing: '探活中',
      keepingAlive: '保活中',
      maxResultsTooltipTitle: '历史记录上限',
      maxResultsTooltipMeaning: '每个计划保留最近的请求结果。',
      maxResultsTooltipBody: '超过上限后自动清理最早的记录。',
    ...
    proxies: {
      ...
      fallbackDirect: '回退直连',
      backupProxy: '备用代理',
      nodeShareLink: '节点分享链接',
      subscriptionSource: '订阅源',
      clientNodeConfig: 'Clash / sing-box 配置',
      allSources: '全部订阅源',
      ...
      modeStandard: '标准代理',
      modeShareLink: '分享链接',
      modeSubscription: '机场订阅',
      modeConfig: 'Sing-box / Clash 配置',
      modeBatch: '批量节点',
      shareLinkInput: '现代分享链接',
      shareLinkPlaceholder: '粘贴 vmess://、vless://、trojan://、ss://、hysteria2://、tuic:// 等节点链接',
      shareLinkHint: '支持常见 V2RayN、Clash 与 Sing-box 分享协议，节点密钥仅提交到管理员接口。',
      subscriptionName: '订阅名称',
      subscriptionNamePlaceholder: '请输入机场订阅名称',
      ...
      refreshIntervalHint: '刷新间隔必须为 5-10080 分钟。',
      importNamePrefix: '名称前缀（可选）',
      importNamePrefixPlaceholder: '未填写时使用节点名称',
      configInput: 'Sing-box / Clash 配置',
      configPlaceholder: '粘贴 Sing-box JSON 或 Clash YAML 配置',
      configHint: '将自动识别配置中的出站或代理节点。',
      configFile: '配置文件（可选）',
      configFileNotSelected: '未选择配置文件',
      configFileTypes: '支持 JSON、YAML、YML、TXT、CONF，最大 8 MB',
      replaceConfigFile: '更换文件',
      clearConfigFile: '清除配置文件',
      configFileUnsupported: '不支持该文件格式，请选择 JSON、YAML、YML、TXT 或 CONF 文件',
      configFileTooLarge: '配置文件不能超过 8 MB',
      configFileEmpty: '配置文件内容为空',
      configFileReadFailed: '无法读取配置文件',
      batchModernPlaceholder: '每行粘贴一个代理或现代节点分享链接',
      batchModernHint: '支持 HTTP、HTTPS、SOCKS、VMess、VLESS、Trojan、Shadowsocks、Hysteria、TUIC 等链接。',
      totalCount: '总数',
      validCount: '有效',
      invalidLabel: '无效',
      duplicateLabel: '重复',
      xrayNodeUri: 'Xray 节点 URI',
      xrayNodeUriPlaceholder: 'vless://、vmess://、trojan:// 或 ss:// 节点链接',
      xrayNodeUriHint: '节点密钥仅在管理员接口和受控 Xray 运行时中使用。',
      xrayNodeUriRequired: '请输入 Xray 节点 URI',
      showCredentials: '显示认证信息',
      hideCredentials: '隐藏认证信息',
      publicToUsers: '公开给普通用户使用',
      importContentRequired: '请粘贴至少一个支持的代理节点或配置。',
      importSuccess: '导入成功，新增 {count} 个代理',
      importPartial: '导入完成，新增 {count} 个代理，{errors} 个节点失败',
      sourceCreated: '订阅源已创建并同步，新增 {count} 个代理',
      sourceSyncPartial: '订阅同步完成，新增或更新 {count} 个代理，{errors} 个节点失败',
      sourceManager: '订阅源管理',
      sourceManagerTitle: '机场订阅源管理',
      sourceLoading: '正在加载订阅源...',
      sourceEmpty: '暂无订阅源',
      sourceColumnName: '名称 / 订阅地址',
      sourceColumnVisibility: '可见性',
      sourceColumnNodes: '节点数',
      sourceColumnInterval: '刷新间隔',
      sourceColumnQuota: '流量 / 到期',
      sourceColumnStatus: '同步状态',
      sourceColumnActions: '操作',
      sourceIntervalValue: '{minutes} 分钟',
      sourceNodeCount: '{active} / {total}',
      sourceFilterBySource: '只看该订阅源导入的代理',
      sourceNextSyncAt: '下次同步：{time}',
      sourceSyncPausedHint: '自动同步已暂停',
      sourceExpiresAt: '到期：{time}',
      sourceTrafficRemaining: '剩余 {remaining} / {total}',
      sourceTrafficUsedOnly: '已用 {used}',
      sourceAutoSyncEnabled: '开启自动同步',
      sourcePauseSync: '暂停自动同步',
      sourceResumeSync: '恢复自动同步',
      sourceSyncPaused: '已暂停该订阅源的自动同步',
      sourceSyncResumed: '已恢复该订阅源的自动同步',
      sourceSyncAll: '一键同步全部',
      sourceSyncAllDone: '全部订阅源同步完成',
      sourceSyncAllPartial: '同步完成，{failed} 个订阅源失败',
      sourceSyncAllSummary: '共 {total} 个订阅源：成功 {success}，部分成功 {partial}，失败 {failed}，已暂停 {skipped}，未完成 {deferred}；新增节点 {created}，更新 {updated}',
      sourceAddTitle: '添加订阅源',
      sourceEditTitle: '编辑订阅源',
      sourceSave: '保存订阅源',
      sourceUpdate: '更新订阅源',
      sourceSync: '立即同步',
      sourceSaved: '订阅源已保存',
      sourceSaveFailed: '保存订阅源失败',
      sourceSynced: '订阅同步完成，新增或更新 {count} 个代理',
      sourceSyncFailed: '订阅同步失败',
      sourceLoadFailed: '加载订阅源失败',
      sourceDeleted: '订阅源已删除',
      sourceDeleteFailed: '删除订阅源失败',
      sourceDeleteTitle: '删除订阅源',
      sourceDeleteConfirm: '确定删除订阅源“{name}”吗？已导入的代理不会自动删除。',
      sourceCreatedSyncFailed: '订阅源已保存，但首次同步失败。请在订阅源管理中重试。',
      sourceStatusSuccess: '同步成功',
      sourceStatusPartial: '部分成功',
      sourceStatusError: '同步失败',
      sourceStatusSyncing: '同步中',
      sourceStatusPending: '等待同步',
      sourceUrlHidden: '订阅地址已隐藏',
      detailsHidden: "代理详情不可见",
    },
