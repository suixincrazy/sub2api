export default {
    ...
    channels: {
      ...
      form: {
        ...
        pricePlaceholder: '默认',
        derivedMultipliers: '派生倍率',
        derivedMultipliersHint: '只填提示价，其余档位按倍率跟着走；填了绝对价的档位倍率失效',
        derivedCompletionMultiplier: '补全倍率',
        derivedCacheCreationMultiplier: '缓存创建倍率',
        derivedCacheReadMultiplier: '缓存读取倍率',
        fastMultiplier: 'Fast 倍率',
        flexMultiplier: 'Flex 倍率',
        multiplierPlaceholder: '未配置',
        multiplierPositive: 'Fast/Flex 倍率必须大于 0',
        multiplierNonNegative: '派生倍率不能为负数',
