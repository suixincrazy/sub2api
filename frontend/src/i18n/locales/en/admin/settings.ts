export default {
    settings: {
      codexHistoryFilter: {
        ...
        behavior: "Remove historical reasoning and optional message, web search, agent and tool item IDs. Normalize agent plaintext mislabeled as encrypted content. Retain current reasoning effort, call_id pairs, search contents and nested resource references. Force store=false and remove reasoning.encrypted_content from include.",
        boundaries: "Uses HTTP/SSE only. Compaction, server-side conversation/item references and other encrypted context are rejected explicitly. Historical reasoning is discarded; genuine encrypted agent task/result content is retained. Use a text summary in a new session when a context reference is rejected. Browser Responses requests are not supported in this mode.",
        filteredRequests: "Filtered requests",
        removedReasoning: "Reasoning items removed",
        removedIds: "Item IDs removed",
        normalizedAgentText: "Agent text parts normalized",
