export default {
    scheduledTests: {
      title: 'Scheduled Keepalive',
      description: 'Send short requests continuously: probe until connected, then keep the account alive at the configured interval. Rate limits honor the upstream waiting time.',
      addPlan: 'Add Keepalive',
      editPlan: 'Edit Keepalive',
      deletePlan: 'Delete Keepalive',
      model: 'Text Model',
      enabled: 'Enabled',
      lastRun: 'Last Request',
      nextRun: 'Next Request',
      maxResults: 'History Limit',
      noPlans: 'No keepalive plans',
      confirmDelete: 'Delete this keepalive plan and stop further requests?',
      createSuccess: 'Keepalive plan created',
      updateSuccess: 'Keepalive settings updated',
      deleteSuccess: 'Keepalive plan deleted',
      results: 'Keepalive History',
      noResults: 'No keepalive results',
      ...
      keepaliveInterval: 'Minimum Keepalive Interval (seconds)',
      keepaliveMaxInterval: 'Maximum Keepalive Interval (seconds)',
      intervalSummary: 'Retry every {probe}s, keep alive every {min}–{max}s when connected',
      paused: 'Paused',
      probing: 'Probing',
      keepingAlive: 'Keeping Alive',
      maxResultsTooltipTitle: 'History Limit',
      maxResultsTooltipMeaning: 'Keep the most recent results for each plan.',
      maxResultsTooltipBody: 'Older results are removed automatically after reaching the limit.',
    ...
    proxies: {
      ...
      nodeShareLink: 'Node share link',
      subscriptionSource: 'Subscription source',
      clientNodeConfig: 'Clash / sing-box configuration',
      ...
      creationMethod: 'Add method',
      modeStandard: 'Standard proxy',
      modeShareLink: 'Share link',
      modeSubscription: 'Provider subscription',
      modeConfig: 'Sing-box / Clash config',
      modeBatch: 'Batch nodes',
      shareLinkInput: 'Modern share link',
      shareLinkPlaceholder: 'Paste vmess://, vless://, trojan://, ss://, hysteria2://, tuic://, or another node link',
      shareLinkHint: 'Supports common V2RayN, Clash, and Sing-box share protocols. Node secrets are sent only to admin APIs.',
      subscriptionName: 'Subscription name',
      subscriptionNamePlaceholder: 'Enter a provider subscription name',
      subscriptionUrl: 'Subscription URL',
      subscriptionUrlPlaceholder: 'https://example.com/subscription',
      subscriptionUrlRequired: 'Please enter a subscription URL',
      refreshIntervalMinutes: 'Refresh interval (minutes)',
      refreshIntervalHint: 'Refresh interval must be between 5 and 10080 minutes.',
      importNamePrefix: 'Name prefix (optional)',
      importNamePrefixPlaceholder: 'Uses node names when left empty',
      configInput: 'Sing-box / Clash configuration',
      configPlaceholder: 'Paste a Sing-box JSON or Clash YAML configuration',
      configHint: 'Outbound or proxy nodes in the configuration are detected automatically.',
      configFile: 'Configuration file (optional)',
      configFileNotSelected: 'No configuration file selected',
      configFileTypes: 'JSON, YAML, YML, TXT, or CONF; up to 8 MB',
      replaceConfigFile: 'Replace file',
      clearConfigFile: 'Clear configuration file',
      configFileUnsupported: 'Unsupported file type. Select a JSON, YAML, YML, TXT, or CONF file.',
      configFileTooLarge: 'The configuration file must not exceed 8 MB.',
      configFileEmpty: 'The configuration file is empty.',
      configFileReadFailed: 'Unable to read the configuration file.',
      batchModernPlaceholder: 'Paste one standard proxy or modern share link per line',
      batchModernHint: 'Supports HTTP, HTTPS, SOCKS, VMess, VLESS, Trojan, Shadowsocks, Hysteria, TUIC, and more.',
      totalCount: 'Total',
      validCount: 'Valid',
      invalidLabel: 'Invalid',
      duplicateLabel: 'Duplicate',
      xrayNodeUri: 'Xray node URI',
      xrayNodeUriPlaceholder: 'vless://, vmess://, trojan://, or ss:// node URI',
      xrayNodeUriHint: 'Node secrets are only used by admin APIs and the controlled Xray runtime.',
      xrayNodeUriRequired: 'Enter an Xray node URI',
      showCredentials: 'Show credentials',
      hideCredentials: 'Hide credentials',
      publicToUsers: 'Make available to regular users',
      importContentRequired: 'Paste at least one supported proxy node or configuration.',
      importSuccess: 'Import completed with {count} new proxies',
      importPartial: 'Import completed with {count} new proxies and {errors} failed nodes',
      sourceCreated: 'Subscription source created and synced with {count} new proxies',
      sourceSyncPartial: 'Subscription sync completed with {count} new or updated proxies and {errors} failed nodes',
      sourceManager: 'Subscription Sources',
      sourceManagerTitle: 'Proxy Subscription Sources',
      sourceLoading: 'Loading subscription sources...',
      sourceEmpty: 'No subscription sources yet',
      sourceColumnName: 'Name / Subscription URL',
      sourceColumnVisibility: 'Visibility',
      sourceColumnNodes: 'Nodes',
      sourceColumnInterval: 'Refresh Interval',
      sourceColumnQuota: 'Traffic / expiry',
      sourceColumnStatus: 'Sync Status',
      sourceColumnActions: 'Actions',
      sourceIntervalValue: '{minutes} minutes',
      sourceNodeCount: '{active} / {total}',
      sourceFilterBySource: 'Show only proxies imported from this source',
      sourceNextSyncAt: 'Next sync: {time}',
      sourceSyncPausedHint: 'Automatic sync paused',
      sourceExpiresAt: 'Expires: {time}',
      sourceTrafficRemaining: '{remaining} left of {total}',
      sourceTrafficUsedOnly: '{used} used',
      sourceAutoSyncEnabled: 'Enable automatic sync',
      sourcePauseSync: 'Pause automatic sync',
      sourceResumeSync: 'Resume automatic sync',
      sourceSyncPaused: 'Automatic sync paused for this source',
      sourceSyncResumed: 'Automatic sync resumed for this source',
      sourceSyncAll: 'Sync all',
      sourceSyncAllDone: 'All sources synced',
      sourceSyncAllPartial: 'Sync finished, {failed} sources failed',
      sourceSyncAllSummary: '{total} sources: {success} ok, {partial} partial, {failed} failed, {skipped} paused, {deferred} deferred; {created} new nodes, {updated} updated',
      sourceAddTitle: 'Add Subscription Source',
      sourceEditTitle: 'Edit Subscription Source',
      sourceSave: 'Save Source',
      sourceUpdate: 'Update Source',
      sourceSync: 'Sync Now',
      sourceSaved: 'Subscription source saved',
      sourceSaveFailed: 'Failed to save subscription source',
      sourceSynced: 'Subscription sync completed with {count} new or updated proxies',
      sourceSyncFailed: 'Subscription sync failed',
      sourceLoadFailed: 'Failed to load subscription sources',
      sourceDeleted: 'Subscription source deleted',
      sourceDeleteFailed: 'Failed to delete subscription source',
      sourceDeleteTitle: 'Delete Subscription Source',
      sourceDeleteConfirm: 'Delete subscription source "{name}"? Imported proxies will not be deleted automatically.',
      sourceCreatedSyncFailed: 'The subscription source was saved, but its first sync failed. Retry it from Subscription Sources.',
      sourceStatusSuccess: 'Synced',
      sourceStatusPartial: 'Partially Synced',
      sourceStatusError: 'Sync Failed',
      sourceStatusSyncing: 'Syncing',
      sourceStatusPending: 'Pending',
      sourceUrlHidden: 'Subscription URL hidden',
      detailsHidden: "Proxy details are hidden",
    },
