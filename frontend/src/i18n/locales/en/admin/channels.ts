export default {
    ...
    channels: {
      ...
      form: {
        ...
        derivedMultipliers: 'Derived Multipliers',
        derivedMultipliersHint: 'Set the prompt price only; other tiers follow by multiplier. A tier with an absolute price ignores its multiplier',
        derivedCompletionMultiplier: 'Completion Multiplier',
        derivedCacheCreationMultiplier: 'Cache Creation Multiplier',
        derivedCacheReadMultiplier: 'Cache Read Multiplier',
        ...
        multiplierNonNegative: 'Derived multipliers cannot be negative',
