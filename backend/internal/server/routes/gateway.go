...
func RegisterGatewayRoutes(
	...
	codexHistoryFilter := middleware.NewCodexHistoryFilter(settingService)
	...
	gateway.Use(codexHistoryFilter.Prepare, groupModelAllowlist, codexHistoryFilter.Apply)
	...
	rootRoute := func(method, path string, limit gin.HandlerFunc, handler gin.HandlerFunc) {
		r.Handle(method, path, limit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), codexHistoryFilter.Prepare, groupModelAllowlist, codexHistoryFilter.Apply, compositeTarget, requireGroupAnthropic, handler)
	}
	...
	codexDirect.Use(bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), codexHistoryFilter.Prepare, groupModelAllowlist, codexHistoryFilter.Apply, compositeTarget, requireGroupAnthropic)
	{
