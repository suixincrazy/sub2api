...
func (r *channelRepository) UpdateModelPricing(ctx context.Context, pricing *service.ChannelModelPricing) error {
	...
	result, err := r.db.ExecContext(ctx,
		`UPDATE channel_model_pricing
		 SET models = $1, billing_mode = $2, input_price = $3, output_price = $4, cache_write_price = $5, cache_write_1h_price = $6, cache_read_price = $7, fast_multiplier = $8, flex_multiplier = $9, image_input_price = $10, image_output_price = $11, per_request_price = $12, time_pricing = $13, platform = $14, completion_multiplier = $16, cache_creation_multiplier = $17, cache_read_multiplier = $18, updated_at = NOW()
		 WHERE id = $15`,
		...
		pricing.CompletionMultiplier, pricing.CacheCreationMultiplier, pricing.CacheReadMultiplier,
	)
	if err != nil {
...
func scanModelPricingRows(rows *sql.Rows) ([]service.ChannelModelPricing, []int64, error) {
	...
	for rows.Next() {
		...
		if err := rows.Scan(
			...
			&p.CompletionMultiplier, &p.CacheCreationMultiplier, &p.CacheReadMultiplier,
