...
func TestGeminiForwardNative_PersistentTransportErrorPreservesAccount(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	require.Zero(t, repo.calls, "proxy faults must not freeze the selected account")
