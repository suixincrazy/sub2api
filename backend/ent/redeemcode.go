...
type RedeemCode struct {
	...
	// NULL means system/admin code; non-NULL means user-generated private subscription code.
	...
	// Maximum successful redemptions; each user can redeem once.
...
func (*RedeemCode) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case redeemcode.FieldID, redeemcode.FieldOwnerUserID, redeemcode.FieldUsedBy, redeemcode.FieldGroupID, redeemcode.FieldValidityDays, redeemcode.FieldMaxUses, redeemcode.FieldUsedCount:
...
func (_m *RedeemCode) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case redeemcode.FieldOwnerUserID:
