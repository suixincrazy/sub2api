...
type AccountInfo struct {
	...
	// null when unset). Secrets withheld include the raw Credentials blob
	...
	// proxy credentials and raw node configuration. Also withheld are the
	// Groups/AccountGroups relation graphs (cyclic — group_ids conveys
