...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/smmooooonn/sub2api-xray/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="smmooooonn/sub2api-xray"
...
Documentation=https://github.com/smmooooonn/sub2api-xray
